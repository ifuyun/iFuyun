...
( function ($) {
    ...
    $.Datepicker.prototype = {
        ...
        processError: function () {
            ...
            var opts = this.opts, $elm = this.$elm, isValid = false, actDateStr = $.trim($elm.val()), actDateObj, minDate = this.getDateObj(opts.minDate), maxDate = this.getDateObj(opts.maxDate), returnVal = true;
