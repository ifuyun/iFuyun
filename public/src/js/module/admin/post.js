...
const service = {
    initEvent: function () {
        ...
        tinymce.init({
            ...
            toolbar1: 'fontsizeselect fontselect formatselect | bold italic underline strikethrough | ' +
                'codesample blockquote subscript superscript | alignleft aligncenter alignright alignjustify | bullist numlist',
            toolbar2: 'forecolor backcolor | outdent indent | link anchor image media | table insertdatetime | ' +
                'hr pagebreak | pastetext unlink removeformat | visualblocks code preview fullscreen | undo redo',
            'image_advtab': true,
